...
class TestCLI:
    ...
    def test_config_command(self, mock_save_api_key):
        # Set up command line args
        sys.argv = ["business-finder", "config", "--set-api-key", "new_api_key"]
    ...
    def test_missing_coordinates(self, capsys):
        ...
        sys.argv = ["business-finder", "search", "--api-key", "test_api_key"]
    ...
    def test_json_params(self, mock_get_api_key, mock_search):
        ...
        # Set up command line args
        sys.argv = ["business-finder", "search", "--json-params", json_params]
    ...
    def test_params_file(self, mock_get_api_key, mock_search):
        ...
        # Set up command line args
        sys.argv = ["business-finder", "search", "--params-file", self.temp_file.name]
